...
function TestJSON(){
  ...
  ss.getRangeByName("DF_FORMULA_1").setValues(ImportJSON("https://api.coinmarketcap.com/v1/ticker/?limit=100",null,"noHeaders"));
  //return ImportJSON("https://api.coinmarketcap.com/v1/ticker/?limit=100",null,"noHeaders");
}
